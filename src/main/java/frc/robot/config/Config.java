...
public class Config {
  ...
  public static final PIDConstants SWERVE_TRANSLATION_PID = IS_SPIKE ? new PIDConstants(2.5, 0, 0) : new PIDConstants(7, 0, 0.05);
  public static final PIDConstants SWERVE_ROTATION_PID = IS_SPIKE ? new PIDConstants(1.1, 0, 0.1) : new PIDConstants(4.25, 0, 0.4);
